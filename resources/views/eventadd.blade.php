...
<body>
    ...
    <div class="container">
        <div class="container-fluid">
           <div class="card-header ">Add Event <a href="{{route('list.event')}}"  class="float-right">List Event</a></div>
           <div class="row">
               @if($errors->any())
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="row"><div class="col-md-4">
                                    <select class="form-control" name="frequency" value="" id="frequency">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" name="interval" value="" id="interval">
